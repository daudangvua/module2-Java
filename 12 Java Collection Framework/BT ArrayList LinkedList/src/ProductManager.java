...
public class ProductManager {
    ...
    public void seedData() {
        arrayProduct.add(new Product("1","but",100));
        arrayProduct.add(new Product("2","vo",200));
    }
    ...
    public void deleteProductById() {
        ...
        String id = sc.nextLine();
        Iterator<Product> iterator = arrayProduct.iterator();
